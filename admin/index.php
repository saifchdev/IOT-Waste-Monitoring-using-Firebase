                        ...
                        <div class="app-page-title">
                                ...
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span>1296</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Pending Complaint</div>
                                            <div class="widget-subheading">New Complaints</div>
                                        </div>
                                        <div class="widget-content-right">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Completed Log</div>
                                            <div class="widget-subheading">Data about old compaints</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span>1250</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Manoj Desai</div>
                                                                
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">Ghansoli</td>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Pratik Bharti</div>
                                                               
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">Kharghar</td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Mohit Jain</div>
                                                              
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">Vashi</td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Akanksha Bhagat</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">Nerul</td>
                                                <td class="text-center">
                                                <div class="badge badge-danger">In Progress</div>
                                                </td>
                                                <td class="text-center">
